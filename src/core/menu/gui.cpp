...
bool gui::initialize( ) {
	photon->render->create_font( framework::fonts::normal, "Segoe UI Light", 22, false, sdk::fontflag_antialias );
	photon->render->create_font( framework::fonts::title, "Segoe UI Light", 30, false, sdk::fontflag_antialias );
