...
#define EXPOSE_SINGLE_INTERFACE_GLOBALVAR( class_name, interface_name, version_name, global_var_name ) \
	static void* __create##class_name##interface_name##_interface( ) {                                    \
		return static_cast< interface_name* >( &global_var_name );                                           \
	}                                                                                                     \
	static interface_reg_t __g_create##class_name##interface_name##_reg( __create##class_name##interface_name##_interface, version_name );
